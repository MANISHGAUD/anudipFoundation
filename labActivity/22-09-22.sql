...
insert into employee values(201,"fay","ac_mgr",6500,null,210,20);
...
insert into employee values(205,"ac_mgr","2300",null,101,60);
insert into employee values(206,"nell","sh_clerk",2600,2.5,124,50);
drop table employee;
desc employee;
create table employee(employee_id int(6) ,last_name varchar(25),job_id varchar(10),slalary double(8,2), comm_pct double(4,2),mgr_id int(6),department_id int(4));
insert into employee values(198,"connell","sh_clerk",2600,2.5,124,50);
...
select employee where department_id = 60;
